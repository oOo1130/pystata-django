"""
Django settings for stata project.
...
SECRET_KEY = 'django-insecure-d1znokw%r32!ty4q^3(imgo+!y98wf4z&y!&h696dti0scx3i3'
...
WSGI_APPLICATION = 'stata.wsgi.application'
